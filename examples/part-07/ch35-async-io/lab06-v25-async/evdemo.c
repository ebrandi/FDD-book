/*
 * evdemo.c - v2.5-async reference driver.
 *
 * This is the final combined driver: poll, kqueue, and SIGIO support
 * all layered on a bounded event queue, with an audited detach path
 * and sysctl-based observability. Future drivers that need
 * asynchronous I/O can use this file as a template.
 */
...
evdemo_modevent(module_t mod, int event, void *arg)
{
	...
	case MOD_LOAD:
		...
		printf("evdemo: loaded (lab06-v25-async)\n");
		break;
