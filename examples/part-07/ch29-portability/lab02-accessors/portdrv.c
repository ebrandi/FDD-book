/*
 * portdrv.c - Chapter 29 Lab 2 (accessors introduced).
 *
 * Same driver as Lab 1, but every register access now flows through a
 * pair of inline accessors. The accessors are the first step toward a
 * backend split; see Lab 3 for the next step.
 */
...
/*
 * Accessors. Every register access below goes through these two
 * functions. Introducing the layer does not change behaviour; it
 * gives us a single point of change for Lab 3.
 */
